"use strict";
import { AfterViewChecked, ChangeDetectorRef, Component, Input, OnInit, Output, EventEmitter, ViewChild, forwardRef, AfterViewInit, ElementRef } from "@angular/core";
...
export class CompleterCmp implements ControlValueAccessor, AfterViewChecked, AfterViewInit, OnInit {
